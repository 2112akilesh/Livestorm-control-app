...
@Component({
  ...
  template: `
    <ion-list>
      <ion-item detail="false" [routerLink]="['/tabs/settings']" button (click)="close()">Settings</ion-item>
      <ion-item detail="false"                                   button (click)="goGit(); close()">GitHub Repo</ion-item>
      <ion-item detail="false" lines="none"                      button (click)="logout(); close()">Logout</ion-item>
    </ion-list>
  `
})
